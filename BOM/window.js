...
console.log('Ancho de pantallabsin barra de Windows:' , window.screen.availWidth);
console.log('Alto de pantallabsin barra de Windows:' , window.screen.availHeight);